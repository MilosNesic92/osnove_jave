...
//			Likes 3 | Shares 1
		...
		a.setImePrezimeObjava("Janko Jankovic");
		a.setImePrezimeProfil("Nikola Nikolic");
		a.setTekst("Tekst poruke.");
		
		
		facebookPost b = new facebookPost(); 
		b.setImePrezimeObjava("Stanko Stankovic");
		b.setImePrezimeProfil("Barry White");
		b.setTekst("Tekst Poruke 2.");
