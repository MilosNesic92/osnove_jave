...
//		U glavnom programu kreirati minimum 2 proizvoda i za svaki od njih pozvati svaku od definisanih funkcija.
		...
		ProizvodClass proizvod = new ProizvodClass();
		
		proizvod.naziv = "Jabuke";
		proizvod.cena = 175;
		proizvod.tezina = 150;
		proizvod.stampaj();
		proizvod.povecajCenu(120);
		proizvod.stampaj();
		double cenaSaPopustom = proizvod.vratiCenuSaPopustom(30);
		System.out.println("Cena sa popustom je: " + cenaSaPopustom);
		int postarina = proizvod.racunajPostarinu();
		System.out.println("Cena postarine je: " + postarina);
